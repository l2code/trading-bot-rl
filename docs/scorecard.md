...
- **Test discipline.** 315 tests today. Coverage floor 85%. Every
...
| 2026-05-07 D4-b multi-cycle WF (yfinance 2021/2022/2023/2024) | exploratory (yfinance) | **NO_GO multi-year** — all 16 (year × policy) cells NO_GO; set_ranker DD > random in 4-of-4 years; per_strat distinctness survives 4-of-4; masked-PPO ≡ first_fired across regimes | [`2026-05-07_d4b_multi_cycle_yfinance_NO_GO.md`](../research/diary/2026-05-07_d4b_multi_cycle_yfinance_NO_GO.md) |
